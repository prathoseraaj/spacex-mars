const Hero = () => {
  ...
  return (
    <div
      className="h-[100vh] w-full flex justify-center items-center bg-cover bg-center overflow-hidden"
      id="image"
      style={{
        backgroundImage:
          'url("https://www.spacex.com/static/images/mars/2025_Update/mars_hero_d.jpg")',
      }}
    >
